...
export const DEMO_CLAIMS: RefundClaim[] = [
  {
    claim_id: "CLM-001",
    ...
    claim_text:
      "The left front leg of the sectional arrived cracked at the joint — you can see the wood split about 3 inches up from the base. The delivery team noted it too. Attaching photos from multiple angles.",
  },
  {
    claim_id: "CLM-002",
